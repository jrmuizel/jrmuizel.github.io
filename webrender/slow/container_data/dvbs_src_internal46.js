...
if(f&&f[1]){var m=f[1].replace(/\d+$/,""),k=c[m];if(k){for(var t=0;t<k.stats.length;t++){var u=k.stats[t];e[k.prefix+u.prefix]=Math.round(d[u.name])}delete c[m];if(!H(c))break}}}}var l=e;break a}catch(n){}l=void 0}if(l&&H(l))return l}function N(b,c){var e,g=window._dv_win.document.visibilityState;window[b.tagObjectCallbackName]=function(d){var f=window._dv_win.$dvbs;if(f){var m=c?"https:":J();e=d.ImpressionID;f.tags.add(d.ImpressionID,b);f.tags[d.ImpressionID].set({tagElement:b.script,impressionId:d.ImpressionID,
dv_protocol:b.protocol,protocol:m,uid:b.uid,serverPublicDns:d.ServerPublicDns,ServerPublicDns:d.ServerPublicDns});b.script&&b.script.dvFrmWin&&(b.script.dvFrmWin.$uid=d.ImpressionID,f.messages&&f.messages.startSendingEvents&&f.messages.startSendingEvents(b.script.dvFrmWin,d.ImpressionID));(function(){function f(){var c=window._dv_win.document.visibilityState;"prerender"===g&&"prerender"!==c&&"unloaded"!==c&&(g=c,window._dv_win.$dvbs.registerEventCall(d.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(b,
...
b&&void 0!=window.innerWidth&&void 0!=window.innerHeight?5:0}catch(e){return 0}}function S(){try{var b=0,c=function(c,d){d&&32>c&&(b=(b|1<<c)>>>0)},e=function(b,c){return function(){return b.apply(c,arguments)}},g="svg"===document.documentElement.nodeName.toLowerCase(),d=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):g?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},
f=["Moz","O","ms","Webkit"],m=["moz","o","ms","webkit"],k={style:d("modernizr").style},t=function(b,c){function f(){l&&(delete k.style,delete k.modElem)}var e;for(e=["modernizr","tspan","samp"];!k.style&&e.length;){var l=!0;k.modElem=d(e.shift());k.style=k.modElem.style}var g=b.length;for(e=0;e<g;e++){var m=b[e];~(""+m).indexOf("-")&&(m=cssToDOM(m));if(void 0!==k.style[m])return f(),"pfx"==c?m:!0}f();return!1},u=function(b,c,d){var g=b.charAt(0).toUpperCase()+b.slice(1),k=(b+" "+f.join(g+" ")+g).split(" ");
if("string"===typeof c||"undefined"===typeof c)return t(k,c);k=(b+" "+m.join(g+" ")+g).split(" ");for(var l in k)if(k[l]in c){if(!1===d)return k[l];b=c[k[l]];return"function"===typeof b?e(b,d||c):b}return!1};c(0,!0);c(1,u("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,u("shapeOutside","content-box",!0));return b}catch(l){return 0}}function T(){try{var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(f){}var e=0,
g=0;c=function(b,c,d){d&&(e=(e|1<<b)>>>0,g=(g|1<<c)>>>0)};var d=b.document;c(14,0,b.playerInstance&&d.querySelector('script[src*="ads-player.com"]'));c(14,1,(b.CustomWLAdServer||b.DbcbdConfig)&&(a=d.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));c(15,2,b.zpz&&b.zpz.createPlayer);c(15,3,b.vdApp&&b.vdApp.createPlayer);c(15,4,d.querySelector('body>div[class="z-z-z"]'));c(16,5,b.xy_checksum&&b.place_player&&(b.logjwonready&&b.logContentPauseRequested||b.jwplayer));
c(17,6,b==b.top&&""==d.title?(a=d.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);c(17,7,d.querySelector('script[src*="sitewebvideo.com"]'));c(17,8,b.InitPage&&b.cef&&b.InitAd);c(17,9,b==b.top&&""==d.title?(a=d.querySelector("body>#player"),null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);c(17,10,b==b.top&&""==d.title&&b.InitAdPlayer?(a=d.querySelector('body>div[id="kt_player"]'),
null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);c(17,11,null!=b.clickplayer&&null!=b.checkRdy2);c(19,12,b.instance&&b.inject&&d.querySelector('path[id="cp-search-0"]'));return{f:e,s:g}}catch(f){return null}}function R(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},f=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var e=Math.ceil((b.length/
4+2)/16),g=Array(e),n=0;n<e;n++){g[n]=Array(16);for(var h=0;16>h;h++)g[n][h]=b.charCodeAt(64*n+4*h)<<24|b.charCodeAt(64*n+4*h+1)<<16|b.charCodeAt(64*n+4*h+2)<<8|b.charCodeAt(64*n+4*h+3)}g[e-1][14]=8*(b.length-1)/Math.pow(2,32);g[e-1][14]=Math.floor(g[e-1][14]);g[e-1][15]=8*(b.length-1)&4294967295;b=1732584193;h=4023233417;var q=2562383102,y=271733878,B=3285377520,r=Array(80);for(n=0;n<e;n++){for(var p=0;16>p;p++)r[p]=g[n][p];for(p=16;80>p;p++)r[p]=c(r[p-3]^r[p-8]^r[p-14]^r[p-16],1);var v=b;var x=
h;var w=q;var z=y;var A=B;for(p=0;80>p;p++){var E=Math.floor(p/20),C=c(v,5);a:{switch(E){case 0:var D=x&w^~x&z;break a;case 1:D=x^w^z;break a;case 2:D=x&w^x&z^w&z;break a;case 3:D=x^w^z;break a}D=void 0}E=C+D+A+f[E]+r[p]&4294967295;A=z;z=w;w=c(x,30);x=v;v=E}b=b+v&4294967295;h=h+x&4294967295;q=q+w&4294967295;y=y+z&4294967295;B=B+A&4294967295}return d(b)+d(h)+d(q)+d(y)+d(B)}function c(){try{return!!window.sessionStorage}catch(f){return!0}}function e(){try{return!!window.localStorage}catch(f){return!0}}
...
c()?"1":"0"]);d.push(["hls",e()?"1":"0"]);d.push(["odb",typeof window.openDatabase||""]);d.push(["cpu",navigator.cpuClass||""]);d.push(["pf",navigator.platform||""]);d.push(["dnt",navigator.doNotTrack||""]);d.push(["canv",g()]);return b(d.join("=!!!="))}catch(f){return null}}this.createRequest=function(){var b=!1,c=window._dv_win,e=0,g=!1,d;try{for(d=0;10>=d;d++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,e++,b=!0;else{b=!1;break}else{0==d&&(b=!0);break}}catch(q){b=
!1}0==c.document.referrer.length?b=c.location:b?b=c.location:(b=c.document.referrer,g=!0);if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};var f=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();d=f.script;this.dv_script_obj=f;this.dv_script=d;window._dv_win.dvbsProcessed.push(f);
window._dv_win._dvScripts.push(d);var m=d.src;this.dvOther=0;this.dvStep=1;var k=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():A():A();f=window.parent.postMessage&&window.JSON;var t=!0,u=!1;if("0"==dv_GetParam(m,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)u=!0;if(f&&0==u)try{var l=G(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html",
"bst2t_"+k);t=C(l)}catch(q){}l={};try{u=/[\?&]([^&]*)=([^&#]*)/gi;for(var n=u.exec(m);null!=n;)"eparams"!==n[1]&&(l[n[1]]=n[2]),n=u.exec(m);var h=l}catch(q){h=l}h.perf=this.perf;h.uid=k;h.script=this.dv_script;h.callbackName="__verify_callback_"+h.uid;h.tagObjectCallbackName="__tagObject_callback_"+h.uid;h.tagAdtag=null;h.tagPassback=null;h.tagIntegrityFlag="";h.tagHasPassbackFlag="";0==(null!=h.tagformat&&"2"==h.tagformat)&&(n=O(h.script),h.tagAdtag=n.tagAdTag,h.tagPassback=n.tagPassback,n.isBadImp?
...
("2"!=l.tagformat&&(m=m[l.ctx]?m[l.ctx].RecoveryTagID:m._fallback_?m._fallback_.RecoveryTagID:1,1===m&&l.tagAdtag?document.write(l.tagAdtag):2===m&&l.tagPassback&&document.write(l.tagPassback)),l=!0):l=!1;if(l)return{isSev1:!0};this.dvStep=2;N(h,n);d=d&&d.parentElement&&d.parentElement.tagName&&"HEAD"===d.parentElement.tagName;this.dvStep=3;return I(this,h,b,c,e,g,f,t,d,n)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):
dv_sendScriptRequest(b);try{var e=K(this.dv_script_obj&&this.dv_script_obj.injScripts),g=G("about:blank");g.id=g.name;var d=g.id.replace("iframe_","");g.setAttribute&&g.setAttribute("data-dv-frm",d);C(g,this.dv_script);if(this.dv_script){var f=this.dv_script;a:{b=null;try{if(b=g.contentWindow){var m=b;break a}}catch(u){}try{if(b=window._dv_win.frames&&window._dv_win.frames[g.name]){m=b;break a}}catch(u){}m=null}f.dvFrmWin=m}var k=L(g);if(k)k.open(),k.write(e);else{try{document.domain=document.domain}catch(u){}var t=
encodeURIComponent(e.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));g.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+t+"');})()"}}catch(u){e=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"tps30.doubleverify.com",dv_SendErrorImp(e+"/verify.js?ctx=818052&cmp=1619415",[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(u)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=
I);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"97"}};
